...
contract UniswapV2PairTest1 is Test {
    ERC20 token0;
    ERC20 token1;
    UniswapV2Pair pair;
    TestUser testUser;
    ...
    function setUp() public {
        ...
        token0 = new ERC20("Token A", "TKNA");
        token1 = new ERC20("Token B", "TKNB");
    ...
    function testSwapBasicScenario() public {
        ...
        pair.swap(0, amountOut, address(this), "0xxx");
    ...
    function testSwapBasicScenarioReverseDirection() public {
        ...
        pair.swap(0.09 ether, 0, address(this), "sadsadad");
    ...
    function testSwapBidirectional() public {
        ...
        token0.transfer(address(pair), 0.1 ether);
        token1.transfer(address(pair), 0.2 ether);
        pair.swap(0.09 ether, 0.18 ether, address(this), "asdas");
    ...
    function testSwapZeroOut() public {
        ...
        vm.expectRevert();
        pair.swap(0, 0, address(this), "sdasd");
    }
    ...
    function testSwapInsufficientLiquidity() public {
        ...
        vm.expectRevert();
        pair.swap(0, 2.1 ether, address(this), "asdsad");

        vm.expectRevert();
        pair.swap(1.1 ether, 0, address(this), "asdasd");
    }
    ...
    function testSwapUnderpriced() public {
        ...
        token0.transfer(address(pair), 0.1 ether);
        pair.swap(0, 0.09 ether, address(this), "sdaasdasd");
    ...
    function testSwapOverpriced() public {
        ...
        vm.expectRevert();
        pair.swap(0, 0.36 ether, address(this), "adssdad");
    ...
    function testSwapUnpaidFee() public {
        ...
        vm.expectRevert();
        pair.swap(0, 0.181322178776029827 ether, address(this), "asdasd");
    }
